...
if __name__ == '__main__':
    ...
    optim_enc = optim.Adam(filter(lambda p: p.requires_grad, decoder.parameters()), lr=lr_gen,
                           betas=(beta1, beta2))
    ...
    encoder = SwinTransformer(img_size=32, patch_size=4, in_chans=3, num_classes=1024,
